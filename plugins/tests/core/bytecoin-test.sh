...
if [[ ${FILE_cryptonote_config} == *const\ size_t\ *CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW\ *\=\ *${CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW}* ]]
then
...
if [[ ${FILE_cryptonote_config} == *const\ size_t\ *CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE\ *\=\ *${CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE}* ]]
then
